...
public class DrawerSolicitudPrestamoFragment extends Fragment implements View.OnClickListener, DatePickerDialogFragment.DatePickerDialogHandler, TextWatcher {
        ...
        switch (paramView.getId()) {
            case R.id.add_fecha_emision_prestamo:
                new DatePickerBuilder()
                        ...
                        .setTargetFragment(DrawerSolicitudPrestamoFragment.this)
                        .show();
                break;
