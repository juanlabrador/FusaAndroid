...
public class EventoTable {
    ...
    private ContentValues generarValores (int id, String nombre, byte[] logistica,
                                          Date fecha, Date hora, int lugar) {
    ...
    public void insertData(int id, String nombre, byte[] logistica,
                           Date fecha, Date hora, int idLugar) {
        mDatabase.insert(TABLE_NAME, null, generarValores(id, nombre, logistica, fecha, hora, idLugar));
    }
    ...
    public ArrayList<Evento> searchEventos(String fecha) {
        ...
        String[] columnas = new String[] {COLUMN_ID, COLUMN_NOMBRE,
                COLUMN_FECHA, COLUMN_HORA, COLUMN_LOGISTICA, COLUMN_ID_LUGAR};
        ...
        while (mCursor.moveToNext()) {
            ...
            try {
                mEventos.add(new Evento(
                        ...
                        null,
                        mLugarTable.searchLugar(String.valueOf(mCursor.getInt(5))), //Lugar
                         "activo"
                ));
