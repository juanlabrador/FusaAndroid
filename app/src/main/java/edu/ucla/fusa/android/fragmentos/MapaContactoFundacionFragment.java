...
public class MapaContactoFundacionFragment extends Fragment {
    ...
    public static MapaContactoFundacionFragment newInstance() {
        MapaContactoFundacionFragment fragment = new MapaContactoFundacionFragment();
