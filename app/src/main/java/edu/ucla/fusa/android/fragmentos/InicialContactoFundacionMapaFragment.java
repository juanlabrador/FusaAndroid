...
public class InicialContactoFundacionMapaFragment extends Fragment {
    ...
    public static InicialContactoFundacionMapaFragment newInstance() {
        InicialContactoFundacionMapaFragment fragment = new InicialContactoFundacionMapaFragment();
