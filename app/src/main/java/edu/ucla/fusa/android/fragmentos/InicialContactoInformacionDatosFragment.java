 ...
 */
public class InicialContactoInformacionDatosFragment extends Fragment implements View.OnClickListener {
    ...
    public static InicialContactoInformacionDatosFragment newInstance() {
        InicialContactoInformacionDatosFragment activity = new InicialContactoInformacionDatosFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_informacion_contacto_datos, container, false);
