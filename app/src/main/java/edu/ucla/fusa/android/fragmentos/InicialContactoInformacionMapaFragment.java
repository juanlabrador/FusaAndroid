 ...
 */
public class InicialContactoInformacionMapaFragment extends Fragment {
    ...
    public static InicialContactoInformacionMapaFragment newInstance() {
        InicialContactoInformacionMapaFragment activity = new InicialContactoInformacionMapaFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_informacion_contacto_mapa, container, false);
        inicializarMapa();
        return view;
    }
    ...
    private void inicializarMapa() {
        if (gMap == null) {
            gMap = ((SupportMapFragment) getActivity().getSupportFragmentManager()
                    .findFragmentById(R.id.mapContacto)).getMap();
