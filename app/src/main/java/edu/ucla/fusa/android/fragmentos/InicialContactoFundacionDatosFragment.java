...
public class InicialContactoFundacionDatosFragment extends Fragment implements View.OnClickListener {
    ...
    public static InicialContactoFundacionDatosFragment newInstance() {
        InicialContactoFundacionDatosFragment fragment = new InicialContactoFundacionDatosFragment();
